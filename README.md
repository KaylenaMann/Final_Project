...
### Raw_data
**EducationData.csv:** Complete dataset spanning 2016-2018
**Excel_template.csv:** Template for single-row predictions
**data_dictionary:** Variable descriptions and possible value ranges
